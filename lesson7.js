...
var barrier_timer; // Таймер для кирпича
var score = 0; // Результат
var scoreElem = null;
var FB_SPEED = 3000; //Интервал появления препятствия и еды
...
function init() {
    ...
    scoreElem = document.getElementById('scoreEl');
...
function readScore() {
    scoreElem.innerText = 'Score: ' + score.toString();
}
/**
...
function startGame() {
    ...
    barrier_timer = setInterval(createBarrier, FB_SPEED); 
